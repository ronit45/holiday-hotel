              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    ...
                    dataKey="count"
                  >
                    {data.popularDestinations.map((_: any, index: number) => (
                      <Cell
                        key={`dest-${index}`}
              ...
              <ResponsiveContainer width="100%" height={280}>
                <PieChart>
                  <Pie
                    ...
                    cy="50%"
                    labelLine={false}
                    label={({ status, percent, count }: any) =>
                    ...
                    nameKey="status"
                  >
                    {(data.paymentStatusBreakdown ?? []).map(
                      (_: any, index: number) => (
                        <Cell
                          key={`pay-${index}`}
                          fill={COLORS[index % COLORS.length]}
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {data.popularDestinations.map((dest: any) => (
          ...
          <div className="bg-white rounded-xl shadow-xl border p-6 w-full">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {data.hotelPerformance.slice(0, 10).map((hotel: any) => (
                    <tr
